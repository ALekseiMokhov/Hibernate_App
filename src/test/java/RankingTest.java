...
public class RankingTest {
    ...
    private Ranking findRanking(Session session, String subjectName,String observerName, String skill) {
        Query<Ranking>query = session.createQuery("from Ranking r where r.subject.name=:sname and " +
                "r.observer.name=:oname and r.skill.name=:skill");
        query.setParameter("sname",subjectName);
        query.setParameter("oname",observerName);
